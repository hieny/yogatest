                    ...
                    <Fragment>
                        ...
                        >
                            ...
                            <SwiperSlide>
                                <div className='grid grid-cols-12 w-full flex align-items-center justify-content-center px-5' style={{}}>
                                    <div className="left col-span-5">
                                        <img decoding='async' loading='lazy' src="https://mk0yogiapproveddv8to.kinstacdn.com/wp-content/uploads/2020/12/Crow.jpg" className="slider-img-content  d-md-none d-sm-none d-none d-lg-block" alt="..." />
                                    </div>
                                    <div className="right col-span-7 slider-info-text px-14 px-4 ">
                                        <span className="text-gray-400 font-medium text-lg">
